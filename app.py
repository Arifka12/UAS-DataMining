...
# =====================================================
    ...
    st.markdown(
        """
        Masukkan data pasien kemudian pilih algoritma
        yang ingin digunakan untuk melakukan prediksi.
        """
    )
    ...
    if st.button("Prediksi Diabetes"):
        ...
        st.info(
            """
            Prediksi dilakukan menggunakan model Machine Learning
            yang telah dilatih sebelumnya menggunakan dataset
...
# =====================================================
    ...
    st.write("""
    Halaman ini digunakan untuk menganalisis persebaran gerai kopi
    ...
    for i in sorted(cluster["Cluster"].unique()):
        ...
        data = cluster[cluster["Cluster"]==i]
    ...
    if st.button("Prediksi Cluster"):
        ...
        # Menentukan Zona Ramai / Sepi
        rata = cluster.groupby("Cluster")["traffic_flow"].mean()
